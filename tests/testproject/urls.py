...
from tests.testproject import relay_schema
...
urlpatterns = [
    ...
    path(
        "relay_schema",
        csrf_exempt(GraphQLView.as_view(schema=relay_schema.relay_schema)),
    ),
    path(
        "arg_schema_async",
    ...
    path(
        "relay_schema_async",
        csrf_exempt(AsyncGraphQLView.as_view(schema=relay_schema.relay_schema)),
    ),
